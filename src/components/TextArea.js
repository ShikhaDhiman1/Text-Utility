...
export default function TextArea() {
    ...
    const darkMode = ()=>{
        ...
        document
          ...
          .setAttribute(
            "style",
            "color:white; background-image:radial-gradient(black, black);"
          );
          const btns = Array.prototype.slice.call(
            document.getElementsByClassName("btn-primary")
          );
          btns.forEach(setBtnStyle);
          function setBtnStyle(item){
            ...
            //   this.setAttribute("style", "none");
            // });
            item.classList.add("btn-primary-light")
          }
    }
    const lightMode = () => {
        setStyle({mystyle})
        document
          ...
          .setAttribute(
            "style",
            "color:black; background-color:white; backgroung-image:radial-gradient(coral,rgb(152, 235, 10));"
          );
          const btns = Array.prototype.slice.call(
            document.getElementsByClassName("btn-primary")
          );
          btns.forEach(function(item){
            item.classList.remove("btn-primary-light")
          })
